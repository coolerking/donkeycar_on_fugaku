...
echo "**** 13openblas.sh start ****"
date

echo "** 1301 set system environments **"
...
echo "** 1302 set virtualenv env **"
cd ~/local/aarch64/virtualenv
source $ENV_NAME/bin/activate


echo "** 1303 set spack env **"
cd ~/

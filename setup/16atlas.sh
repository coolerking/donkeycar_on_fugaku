...
export PACKAGE_NAME="atlas"

echo "**** 16atlas.sh start ****"
date

echo "** 1601 set system environments **"
...
echo "** 1602 set virtualenv env **"
cd ~/local/aarch64/virtualenv
source $ENV_NAME/bin/activate


echo "** 1603 set spack env **"
cd ~/

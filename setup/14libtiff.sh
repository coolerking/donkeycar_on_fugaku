...
export PACKAGE_NAME="libtiff"

echo "**** 14libtiff.sh start ****"
date

echo "** 1401 set system environments **"
...
echo "** 1402 set virtualenv env **"
cd ~/local/aarch64/virtualenv
source $ENV_NAME/bin/activate


echo "** 1403 set spack env **"
cd ~/

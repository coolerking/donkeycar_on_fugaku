...
echo "** 00 setup environment test_mesa_gl **"
date
#cd ~/local/aarch64/virtualenv/
#rm -rf ./test_mesa
source ~/spack/share/spack/setup-env.sh
#spack env remove -y test_mesa_gl
spack env create test_mesa_gl
spack env activate test_mesa_gl
spack env status
...
echo "** 01 mesa+opengl start **"
spack install mesa+opengl ldlibs="-ltinfo"
date


echo "**** 99 eval gl.h****"
cd ~/spack/var/spack/environments/test_mesa_gl
